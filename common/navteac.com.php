...
<div id="acc-nav" class="acc-nav">
    ...
    <ul>
        ...
        <li><a href="#"><i class="material-icons">person_add</i>Accept Student Acc.</a></li>
...
<div id="sch-nav" class="sch-nav">
    ...
    <ul>
        ...
        <li><a href="#"><i class="material-icons">add</i>create new class</a></li>
        <li><a href="#"><i class="material-icons">assessment</i>create new quiz</a></li>
    </ul>
    <i class="material-icons" id="closeNav"  onclick="CloseNav()">backspace</i>
</div>
